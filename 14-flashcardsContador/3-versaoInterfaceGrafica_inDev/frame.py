...
class Interface(ttk.Frame):
    def __init__(self, parent):
        ...
        self.lb1 = ttk.Label(
            self.frameRecomecar,
            text='Cartas para Recomeçar:', width=20, font='arial 24')
        self.lb_numero1 = ttk.Label(
            self.frameRecomecar,
            text='0', foreground='purple',
            font='arial 24 bold', width=2)

        self.lb2 = ttk.Label(
            self.frameComecar,
            text='Cartas para   Começar:',
            width=20, font='arial 24')

        self.lb_numero2 = ttk.Label(
            self.frameComecar,
            text='0', foreground='blue',
            font='arial 24 bold', width=2)

        self.lb_falta = ttk.Label(
            self.frameTotal,
            text='Faltam:',
            width=8,
            font='arial 24')

        self.lb_faltaNum = ttk.Label(
            self.frameTotal,
            text='0',
            foreground='red',
            width=2,
        ...
        self.lb_total = ttk.Label(
            self.frameTotal,
            text='     Total:', width=9, font='arial 24')
        self.lb_totalNum = ttk.Label(
            self.frameTotal,
            text='0', foreground='blue', font='arial 24 bold')

        self.lb_lista1 = ttk.Label(
            self, text='', foreground='purple', font='arial 24 bold')
        self.lb_lista2 = ttk.Label(
            self, text='', foreground='blue', font='arial 24 bold')
        ...
        self.frameRecomecar.pack(pady=5)
        self.frameComecar.pack(pady=5)
        self.frameTotal.pack(pady=5)

        self.lb_lista1.pack(pady=5)
        self.lb_lista2.pack(pady=5)

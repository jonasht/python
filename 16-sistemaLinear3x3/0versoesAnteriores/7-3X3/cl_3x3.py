...
class cl_3x3:
    ...
    def __init__(self,conta):
        ...
        self.delta = self.somarMatriz(self.matriz_delta)
        self.deltaX = self.somarMatriz(self.matriz_deltaX)
        self.deltaY = self.somarMatriz(self.matriz_deltaY)
        self.deltaZ = self.somarMatriz(self.matriz_deltaZ)
